...
dashboard: monitor-start tps-proxy-start
	...
	@python3 -c "import plotext" || pip3 install --user --break-system-packages plotext==5.2.8
	@echo "Starting TUI dashboard..."
	@PYTHONPATH=~/.local/lib/python3.12/site-packages python3 ./src/monitor_tui.py
